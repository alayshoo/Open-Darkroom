...
pub struct PreparedImage {
    ...
    /// Linearised whole-frame overview, same format as the preview. The live
    /// histogram reads this rather than the preview, so it keeps describing the
    /// whole image once the preview becomes a crop tile from the pyramid.
